...
def compute_intervals(
    ...
    """
    Computes persistence homology intervals given a persistence complex, assumed to be in filtration order. We also assume the maximum dimension of the persistence complex is one more than the max dimension of the algorithm.
    """
    ...
    # the simplex is in filtration order, which is important for the use of max_index
